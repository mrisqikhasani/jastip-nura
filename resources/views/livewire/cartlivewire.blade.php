<div class="flex flex-col lg:flex-row gap-6">
  ...
  <div class="flex-1 space-y-4">
    @forelse ($cart->cartLineItems as $item)
    <div class="rounded-lg border border-gray-400 bg-white p-4 shadow-sm md:p-6 mb-4">
      ...
      <div class="flex items-center justify-between md:order-3 md:justify-end gap-4">
        ...
        <button wire:click="decrement({{ $item->id }})" type="button"
          ...
          <svg class="h-3 w-3 text-gray-900 " fill="none" viewBox="0 0 18 2" xmlns="http://www.w3.org/2000/svg">
        ...
        <button wire:click="increment({{ $item->id }})" type="button"
          class="inline-flex h-6 w-6 items-center justify-center rounded-md border border-gray-300 bg-gray-100 hover:bg-gray-200">
          <svg class="h-3 w-3 text-gray-900 " fill="none" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
  ...
  @empty
    <div class="grid place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <h3 class="mt-4 text-2xl font-semibold tracking-tight text-balance text-indigo-900 sm:text-4xl">Keranjang Kamu
        Masih Kosong</h3>
      <p class="mt-6 text-sm font-medium text-pretty text-gray-500 sm:text-xl/8">Silahkan tambahkan produk pilihanmu
        ke keranjang.</p>
