        ...
        <section class="container mx-auto my-3 flex w-full flex-col gap-3 px-4 md:hidden">
            ...
            <div class="flex w-full border px-4 py-4">
                <div class="ml-3 flex w-full flex-col justify-center">
                    ...
                    <p class="py-3 text-xl font-bold text-violet-900">Rp{{ $order->total_price }} </p>
            ...
            <table class="table-fixed">
                ...
                <tbody>
                    ...
                    <tr class="h-[100px] border-b">
                        ...
                        <td class="text-center align-middle">Rp{{ $order->total_price }}</td>
                        
                        <td class="mx-auto text-center">
                            <span class="border-2 border-green-500 py-1 px-3 text-green-500">{{ $order->status }}</span>
                        </td>
